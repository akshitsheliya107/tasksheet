                ...
                label: (
                  <div className="flex items-center gap-3 text-gray-800 dark:text-white">
                    ...
                    <div className="ml-auto flex items-center gap-3 text-sm">
                      <span className="px-3 py-1 bg-gray-200 dark:bg-white/20 text-gray-800 dark:text-white rounded-full backdrop-blur-sm font-semibold">
                        {finalTime} hrs
                      </span>
                      <span className="px-3 py-1 bg-gray-200 dark:bg-white/20 text-gray-800 dark:text-white rounded-full backdrop-blur-sm font-semibold">
                  ...
                  <table className="w-full border-collapse">
                    <tbody>
                      ...
                      <tr className="bg-[#F8FAFC] dark:bg-[#1A1A1A]">
                        <td
                          className="px-4 py-3 font-bold text-purple-700 dark:text-[#c084fc] border-r border-gray-200 dark:border-[#333333] text-sm"
                          style={{ width: "100px", minWidth: "100px" }}
                        >
                          <div className="flex items-center gap-2 whitespace-nowrap text-purple-700 dark:text-[#c084fc]">
                            ⏱️ Testing Time
                          </div>
                        </td>
                        <td
                          className="px-4 py-3 border-r border-gray-200 dark:border-[#333333]"
                          style={{ width: "460px", minWidth: "460px" }}
                        >
                          <input
                            type="text"
                            value={testing?.note || ""}
                            onChange={(e) => handleFieldChange("note", e.target.value)}
                            className="w-full px-3 py-2 text-sm bg-white dark:bg-[#2A2A2A] border border-gray-300 dark:border-[#404040] text-gray-900 dark:text-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200"
                        ...
                        >
                          <input
                            ...
                            className="w-full px-2 py-2 text-sm text-center bg-white dark:bg-[#2A2A2A] border border-gray-300 dark:border-[#404040] text-gray-900 dark:text-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200"
                            disabled={readOnly}
                            placeholder="Hrs"
                          />
                        </td>
                        ...
                        <td
                          className="px-4 py-3 text-center text-sm font-semibold text-purple-700 dark:text-[#c084fc] border-r border-gray-200 dark:border-[#333333]"
                          style={{ width: "80px", minWidth: "80px" }}
                        >
                          {totalMinutes}
                        </td>
                        <td
                          className="px-4 py-3 text-center text-sm font-bold text-purple-700 dark:text-[#c084fc] border-r border-gray-200 dark:border-[#333333]"
                          style={{ width: "80px", minWidth: "80px" }}
                        >
                          {finalTime}
                        </td>
                      ...
                      <tr className="bg-[#F8FAFC] dark:bg-[#1E1E1E] border-b border-gray-200 dark:border-[#333333]">
                        <td colSpan={12} className="p-0">
                          <div className="testing-additional-details">
                            {config?.enableTestingDetails && (
                              <Collapse
                                ...
                                items={[
                                  {
                                    ...
                                    children: (
                                      <table className="w-full border-collapse">
                                        <tbody>
                                          {/* Testing Module */}
                                          <tr className="bg-transparent border-b border-gray-200 dark:border-[#333333] hover:bg-gray-50 dark:hover:bg-[#2A2A2A] transition-colors duration-200 animate-fadeSlideIn">
                                            <td
                                              className="px-5 py-3 text-sm font-semibold text-gray-600 dark:text-gray-400 border-r border-gray-200 dark:border-[#333333]"
                                              style={{ width: "150px" }}
                                            >
                                              Testing Module
                                            </td>
                                          ...
                                          {/* Test Scenario */}
                                          <tr className="bg-transparent border-b border-gray-200 dark:border-[#333333] hover:bg-gray-50 dark:hover:bg-[#2A2A2A] transition-colors duration-200 animate-fadeSlideIn">
                                            <td className="px-5 py-3 text-sm font-semibold text-gray-600 dark:text-gray-400 border-r border-gray-200 dark:border-[#333333]">
                                              Test Scenario
                                            </td>
                                            <td colSpan={11} className="px-3 py-3">
                                              <textarea
                                          ...
                                          {/* Bugs Header */}
                                          <tr className="bg-[#F1F5F9] dark:bg-[#222222] border-b border-gray-200 dark:border-[#333333] animate-fadeSlideIn">
                                            <td colSpan={10} className="px-5 py-4">
                                              <div className="flex items-center gap-2">
                                                <span className="font-bold text-gray-700 dark:text-gray-300">
                                                  🐛 Bugs Found:
                                                </span>
                                                <span className="px-3 py-1 bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 rounded-full text-xs font-bold border border-purple-200 dark:border-purple-700/50 shadow-sm">
                                          ...
                                          {testing.bugs?.map((bug, index) => (
                                            <tr
                                              key={bug.id}
                                              className="bg-transparent border-b border-gray-200 dark:border-[#333333] hover:bg-gray-50 dark:hover:bg-[#2A2A2A] transition-colors duration-200 animate-fadeSlideIn"
                                              style={{
